...
#define DEFAULTOPTIONS_SPARSEGRAPH(options)                                                                                                                                                            \
  optionblk options = { 0, FALSE, FALSE, FALSE, TRUE, FALSE, CONSOLWIDTH, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 100, 0, 1, 0, &dispatch_sparse, FALSE, NULL }
#define DEFAULTOPTIONS_SPARSEDIGRAPH(options)                                                                                                                                                          \
  optionblk options = { 0, TRUE, FALSE, FALSE, TRUE, FALSE, CONSOLWIDTH, NULL, NULL, NULL, NULL, NULL, NULL, adjacencies_sg, 100, 0, 999, 0, &dispatch_sparse, FALSE, NULL }
...
extern void init_sg(graph*, graph**, graph*, graph**, int*, int*, set*, struct optionstruct*, int*, int, int);
extern void cleanup_sg(graph*, graph**, graph*, graph**, int*, int*, optionblk*, statsblk* stats, int, int);
...
extern void sparsenauty(sparsegraph* g, int*, int*, int*, optionblk*, statsblk*, sparsegraph*);
