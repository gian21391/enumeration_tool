...
set(benchmark_BINARY_ROOT_DIR "" CACHE PATH "Folder containing benchmark library")
set(benchmark_SOURCE_ROOT_DIR "" CACHE PATH "Folder containing benchmark sources")

find_path(benchmark_INCLUDE_DIR "benchmark/benchmark.h"
  PATHS ${benchmark_SOURCE_ROOT_DIR}
  PATH_SUFFIXES include
  NO_DEFAULT_PATH)
find_path(benchmark_INCLUDE_DIR "benchmark/benchmark.h")

find_library(benchmark_LIBRARY NAMES "benchmark"
  PATHS ${benchmark_BINARY_ROOT_DIR}
